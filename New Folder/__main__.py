...
import athon
from athon import BOTLOG_CHATID, PM_LOGGER_GROUP_ID
...
LOGS = logging.getLogger("سورس ادثون")
cmdhr = Config.COMMAND_HAND_LER

print(athon.__copyright__)
print(f"المرخصة بموجب شروط  {athon.__license__}")

cmdhr = Config.COMMAND_HAND_LER

try:
    LOGS.info("⌭ بـدء تنزيـل ادثون ⌭")
...
async def startup_process():
    ...
    LOGS.info(f"⌔┊تـم تنصيـب ادثون . . بنجـاح ✓")
    await verifyLoggerGroup()
